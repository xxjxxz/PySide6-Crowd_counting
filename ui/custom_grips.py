...
class Widgets(object):
    def top(self, Form):
        ...
        self.top_left.setStyleSheet(u"background-color: rgb(0, 85, 255);")
        ...
        self.top.setStyleSheet(u"background-color: rgb(0, 85, 255);")
        ...
        self.top_right.setStyleSheet(u"background-color: rgb(0, 85, 255);")
    ...
    def bottom(self, Form):
        ...
        self.bottom_left.setStyleSheet(u"background-color: rgb(0, 85, 255);")
        ...
        self.bottom.setStyleSheet(u"background-color: rgb(0, 85, 255);")
        ...
        self.bottom_right.setStyleSheet(u"background-color: rgb(0, 85, 255);")
