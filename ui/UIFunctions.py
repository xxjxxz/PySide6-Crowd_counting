...
class UIFuncitons(MainWindow):
    ...
    def maximize_restore(self):
        ...
        if status == False: 
            ...
            self.btn_maxscr.setToolTip("Restore")
            ...
            self.btn_maxscr.setToolTip("Maximize")
    ...
    def uiDefinitions(self):
        ...
        # MINIMIZE
        self.btn_minscr.clicked.connect(lambda: self.showMinimized())
        # MAXIMIZE/RESTORE
        self.btn_maxscr.clicked.connect(lambda: UIFuncitons.maximize_restore(self))
        # CLOSE APPLICATION
